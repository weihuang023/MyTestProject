...
//		    goToCheckOut(driver,zipCode,locationType,deliveryDate);
//		    System.out.println("GOTO CKECK OUT Page");
//		    goToPlaceOrder(driver,title,firstName,lastName, locationType,addressLine1,telephone);
//		    System.out.println("GOTO PLACE ORDER Page");	
//		    
		    driver.quit();
		}
		 System.out.println("------------------------ CLUB ITEM Test Case -----------------------------");
...
//	    wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("prodimglarge")));
	...
	public void goToCheckOut(WebDriver driver, String zipCode, String locationType, String deliveryDate)throws InterruptedException{
		WebDriverWait wait = new WebDriverWait(driver, 60);
	    if(this.getPage().contains("CLUB")){
	    	System.out.println("Select Starting Month");
	        new Select(driver.findElement(By.id("ItemStartMonth"))).selectByVisibleText("April");
	        
	    	System.out.println("Select Club Length");
	    	if(this.getPage().contains("HND")){
	...
	public void goToPlaceOrder(WebDriver driver, String title, String firstName, String lastName, String locationType, String addressLine1, String telephone) throws InterruptedException{
